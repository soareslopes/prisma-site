    ...
    <main>
      ...
      <div className="py-24 lg:py-32" style={{ backgroundColor: '#0A0F1E' }}>
        <div className={W}>
          ...
          <p className="text-[17px] leading-[1.75] max-w-2xl" style={{ color: 'rgba(255,255,255,0.52)' }}>
            Analysis, methodological discussions and perspectives from the Prisma research team on spatial intelligence, territorial analytics and evidence-based decision-making.
          </p>
        </div>
      </div>
      ...
      {featured && (
        <div style={{ backgroundColor: '#F7F7F7', borderBottom: '1px solid #E5E5E5' }}>
          <div className={`${W} py-18 lg:py-22`}>
            <p className="text-[11px] font-semibold tracking-[0.14em] uppercase mb-8" style={{ color: '#2E7CF6' }}>
              Featured Article
            </p>
            <Link to={`/insights/${featured.id}`} className="group">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                ...
                <div className="lg:col-span-4">
                  <div
                    className="p-7"
                    style={{ backgroundColor: '#FFFFFF', border: '1px solid #E5E5E5', borderLeft: '3px solid #2E7CF6' }}
                  >
                    <p className="text-[14px] leading-[1.75] italic" style={{ color: '#555555' }}>
                      "{featured.excerpt.slice(0, 200)}..."
                    </p>
                    <p className="text-[12px] mt-5 font-medium" style={{ color: '#AAAAAA' }}>
                      — {featured.author}
                    </p>
                  </div>
                </div>
      ...
      {/* Search + Filters */}
      <div className={`${W} py-14 lg:py-18`}>
        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          ...
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 text-[13px] outline-none transition-colors duration-200 focus:border-[#2E7CF6]"
              style={{
        ...
        {filtered.length === 0 ? (
          <div className="py-24 text-center">
            <p className="text-[16px]" style={{ color: '#AAAAAA' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {filtered.map((insight) => (
              ...
              >
                ...
                <p className="text-[14px] leading-[1.75] mb-5 line-clamp-3" style={{ color: '#777777' }}>
                  {insight.excerpt}
                </p>
